...
<body>
            ...
            <div class="links">
                <ul class="list">
                    <li id="genreli">Skills<img src="images/down-arrow-head.png" alt="down-arrow-head"
                        ...
                        <ul class="sublist">
                            <form action="search.php" method="post">
                                <li><input type="submit" value="Web&nbsp;Development" name="skill_set" id="" class="skill_dd"> </li>
                                <li><input type="submit" value="App&nbsp;Development" name="skill_set" id="" class="skill_dd"> </li>
                                <li><input type="submit" value="Competitive&nbsp;Programming" name="skill_set" id="" class="skill_dd"> </li>
                                ...
                                <li><input type="submit" value="Data&nbsp;Science" name="skill_set" id="" class="skill_dd"> </li>
                    ...
                    <li id="langLi">Section <img src="images/down-arrow-head.png" alt="down-arrow-head"
                        ...
                        <ul class="sublist" >
                            <form action="search.php" method="post">
                            <li><input type="submit" value="Section&nbsp;A" name="skill_set" id="" class="skill_dd"> </li>
                                <li><input type="submit" value="Section&nbsp;B" name="skill_set" id="" class="skill_dd"> </li>
    ...
    <section class="search_sec" id="sectiona">
        <!-- search -->
        <div class="search">
            <form method="GET" id="search-frm" class="search-frm" action="search.php">


                <div class="wrapper-search-bar">
                    <input type="text" name="search-bar" id="search-bar" class="search-bar"
                        placeholder="search by name or skill">
                    <div class="filter-pallete">
                        <!--skills:- 
            web dev--          1  
            app dev--          2  
            UI/UX--            3
            ...
            -->
                        <select name="skill" id="skill">
                            ...
                            <option value="8">AR/VR/XR</option>
                ...
                <div class="btns">
                    <div class="search-button" id="filter"><img src="images/filter.png" alt="search-icon" class="sbtn">
                    </div>
                    <button type="submit" class="search-button"><img src="images/search-icon.png" alt=""
                            class="sbtn"></button>
                </div>
    ...
    <div class="slider">
        <div class="sec" id="slid-seca">Sec A</div>
        <div class="sec" id="slid-secb">Sec B</div>
    </div>
    <form action="search.php" method="post">
    <section class="topper-info seca" id="seca_t">
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Sourav Singh</div>
                <div class="sec">sec A</div>
                <div class="skills"><a href="https://www.linkedin.com/in/srvsi" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE064" name="card" id="" class="data_overlay_submit">     
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Shobhit Kumar
                </div>
                <div class="sec">sec A</div>
                <div class="skills"><a href="https://www.linkedin.com/in/shobhit-kumar-2335csda
                    " class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE032" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Uday Gaidhane</div>
                <div class="sec">sec A</div>
                <div class="skills"><a href="https://www.linkedin.com/in/udhay-gaidhane-bb7375167" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE043" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Nikhil Dahriya</div>
                <div class="sec">sec A</div>
                <div class="skills"><a href="https://www.linkedin.com/nikhil-dahhriya-b22233" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE062" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                ...
                <div class="sec">sec A</div>
                <div class="skills"><a href="https://in.linkedin.com/in/mridul-gupta-0aa3021b1" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE092" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                ...
                <div class="sec">sec A</div>
                <div class="skills"><a href="https://in.linkedin.com/in/vaibhav-aggarwal-1043b5122" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE102" name="card" id="" class="data_overlay_submit">
        </div>
        <!-- <div class="outer-crd">
            <img src="images/ks.png" alt="Restaurant Image" class="crd-img">
            <div class="content">
                <div class="text-rating"><strong>Ovens' Pizza Kidwai Nagar</strong></div>
                <div class="text-rating"></div>
            </div>
            <div class="content">
                <div class="text-rating">North Indian,Chinese,Italian...</div>
                <div class="text-rating">&#8377;1500 for two</div>
            </div>
            <hr class="hr1">
            <div class="content">
                <div class="text-rating">Kidwai Nagar , Kanpur</div>
                <div class="text-rating"></div>
            </div>
            <div class="offer"></div>
        </div> -->
    ...
    <section class="topper-info secb" id="secb_t">
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Kinshu Jain</div>
                <div class="sec">sec B</div>
                <div class="skills"><a href="https:://www.instagram.com/jain_kinshu" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE116" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Ambuj Raj</div>
                <div class="sec">sec B</div>
                <div class="skills"><a href="https://in.linkedin.com/in/ambuj-raj-542913201" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE154" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Ayush Babbar</div>
                <div class="sec">sec B</div>
                <div class="skills"><a href="https://in.linkedin.com/in/ayush-babbar-75137a201" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE164" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
            <div class="imagec"></div>
            <div class="data">
                <div class="name">Krushna Patil</div>
                <div class="sec">sec B</div>
                <div class="skills"><a href="" class="liacc">in</a></div>
            </div>
            <input type="submit" value="BT20CSE164" name="card" id="" class="data_overlay_submit">
        </div>
        <div class="tcard">
